...
@section('content')
    @component('dashboard::layouts.components.page')
        ...
        @slot('breadcrumbs', ['dashboard.vendor-services.create'])

        {{ BsForm::resource('services::services')->post(route('dashboard.vendor-services.store'), ['files' => true,'data-parsley-validate']) }}
