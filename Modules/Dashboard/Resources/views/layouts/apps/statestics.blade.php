                        ...
                        <div style="position: relative;">
                            <div id="radial-chart-1" style="min-height: 86.7px;">
                                <div id="apexchartsz1htoduf"
                                    ...
                                    style="width: 58.0875px; height: 86.7px;"><svg id="SvgjsSvg1427" width="65.0875"
                                        ...
                                        <g id="SvgjsG1429" class="apexcharts-inner apexcharts-graphical"
                                            transform="translate(-15.45625, -12)">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        <div>
                            <p class="text-muted fw-medium mt-1 mb-2">{{ __('Admins') }}</p>
                            <h4>{{ $admins_number }}</h4>
                        </div>
                    </div>
                        ...
                        <div style="position: relative;">
                            <div id="radial-chart-2" style="min-height: 86.7px;">
                                <div id="apexchartskpzyj8ms"
                                    ...
                                    style="width: 58.0875px; height: 86.7px;"><svg id="SvgjsSvg1446" width="65.0875"
                                        height="86.7" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    ...
                                                    <g id="SvgjsG1457">
                                                        ...
                                                        <g id="SvgjsG1459" class="apexcharts-datalabels-group"
                                                            ...
                                                            <text id="SvgjsText1460"
                                                                ...
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-datalabel-value"
                                                                style="font-family: Helvetica, Arial, sans-serif;">{{ $admins_number}}</text>
                                                        </g>
                                                    </g>
                                                </g>
                                            </g>
                ...
                </span>{{ __('Total Number of Admins') }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        <div>
                            <p class="text-muted fw-medium mt-1 mb-2">{{ __('Categories') }}</p>
                            <h4>{{ $client_number }}</h4>
                        </div>
                    </div>
                ...
                </span>{{ __('Total Number of Categories') }}</p>
            </div>
        </div>
    </div>
</div>
