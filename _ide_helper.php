...
namespace Illuminate\Support {
    ...
    class Collection {
        /**
         * @see \App\Providers\AppServiceProvider::sortByDate()
         * @param string $column
         * @param bool $descending
         * @static
         */
        public static function sortByDate($column, $descending = true)
        {
            return \Illuminate\Support\Collection::sortByDate($column, $descending);
        }

        /**
         * @see \App\Providers\AppServiceProvider::paginate()
         * @param mixed $perPage
         * @param mixed $total
         * @param mixed $page
         ...
         * @static
         */
        public static function paginateCollection($perPage = 15, $total = null, $page = null, $pageName = 'page')
        {
